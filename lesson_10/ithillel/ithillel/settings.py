"""
Django settings for ithillel project.
...
SECRET_KEY = 'django-insecure-qp!v5nm=2!@krpot&v@&+zb&fm%@9i@dr+5hf)@r#s1unligol'
...
WSGI_APPLICATION = 'ithillel.wsgi.application'
